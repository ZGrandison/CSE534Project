...
namespace Riptide.Transports.Quic
{
    ...
    public class RiptideQuicConnection : Connection, IEquatable<RiptideQuicConnection>
    {
        ...
        private readonly RiptideQuicPeer peer;
        ...
        internal RiptideQuicConnection(IPEndPoint remoteEndPoint, RiptideQuicPeer peer)
        {
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => Equals(obj as RiptideQuicConnection);
        /// <inheritdoc/>
        public bool Equals(RiptideQuicConnection other)
        {
            if (other is null)
                return false;
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        public static bool operator ==(RiptideQuicConnection left, RiptideQuicConnection right)
...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
        public static bool operator !=(RiptideQuicConnection left, RiptideQuicConnection right) => !(left == right);
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    }
}
