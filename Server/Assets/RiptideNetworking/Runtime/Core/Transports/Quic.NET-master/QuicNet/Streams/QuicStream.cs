...
namespace QuicNet.Streams
{
    ...
    public class QuicStream
    {
        ...
        public QuicStream(QuicConnection connection, StreamId streamId, RiptideQuicPeer peer)
        {
            StreamId = streamId;
            Type = streamId.Type;
        ...
        public void ProcessData(StreamFrame frame)
        {
            ...
            if (State == StreamState.SizeKnown && IsStreamFull())
            {
                ...
                OnStreamDataReceived?.Invoke(this, Data, peer);
            }
        }
