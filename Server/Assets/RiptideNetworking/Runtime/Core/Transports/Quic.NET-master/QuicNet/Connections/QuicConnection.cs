...
namespace QuicNet.Connections
{
    public class QuicConnection
    {
        ...
        public QuicStream CreateStream(StreamType type)
        {
            ...
            QuicStream stream = new QuicStream(this, new QuickNet.Utilities.StreamId(streamId, type), peer);
        ...
        private QuicStream OnStreamFrame(Frame frame)
        {
            ...
            {
                stream = new QuicStream(this, streamId, peer);
                ...
                OnStreamOpened?.Invoke(stream, peer);
            }
            else
            {
